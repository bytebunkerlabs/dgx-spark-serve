...
_ASYNC_OUTPUT_TIMEOUT = 600.0  # seconds
# ^ GB10 mod (was 30.0): 30 s between streamed outputs assumes datacenter
# step times. One GB10 runs large shapes at 38+ s/step and the VAE tail
# is minutes — the stock value kills a finished render at the finish line,
# and the abort then crashes DiffusionResultPump (InvalidStateError).
